...
import com.example.mygallary.CommonMethod;
import com.example.mygallary.MemberDTO;

import static com.example.mygallary.CommonMethod.ipConfig;
import static com.example.mygallary.MainActivity.loginDTO;
...
public class LoginSelect extends AsyncTask<Void, Void, String> {
    ...
    //데이터베이스에 삽입결과 0보다 크면 삽입 성공, 같거나 작으면 실패
    // 필수 부분
    // String state = ""; 로그인에서는 state를 안쓰기 때문에 필요없다.
